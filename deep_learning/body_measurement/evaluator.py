...
if __name__ == "__main__":
    config = {
        ...
        'path_dataset': "/home/juhwan/Documents/capstone/body_part_measurement/dataset/korean_body",  # mac이라 path가 다른듯
        ## attention type
    ...
    data_generator_test = BodyPartsMeasurementDataGenerator(config, data_type="train")
